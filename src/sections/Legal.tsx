    ...
    return (
        <section className="bg-gray-200 min-h-screen text-gray-900 items-center overflow-hidden grid p-4 lg:p-32">
            <div>
                ...
                <Link href="/">
                    <button className="mt-24 flex text-gray-900 sm:text-md md:text-md lg:text-lg border border-gray-800 py-2 px-8 hover:bg-opacity-5 hover:bg-indigo-900 hover:text-indigo-600 hover:border-indigo-600 rounded transition">
                        {t("back")}
                    </button>
                </Link>
            </div>
