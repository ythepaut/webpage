            ...
            <div className="bg-gray-100">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4 space-x-4">
                        <span>
                            {t.rich("copyleft", {
                                sourcecode_link: (children) => <a href="https://github.com/ythepaut/webpage"
                                                                  className="text-gray-600 transition hover:text-gray-800"
                                                                  target="_blank"
                                                                  rel="noreferrer">{children}</a>,
                                license_link: () => <a href="https://github.com/ythepaut/webpage/blob/master/LICENSE"
                                                       rel="noopener noreferrer"
                                                       className="text-gray-600 transition hover:text-gray-800"
                                                       target="_blank">GNU GPL v.3.0</a>
                            })}
                        </span>
                        <span>|</span>
                        <Link href="/legal" scroll={false}>
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start text-xl space-x-3">
                        <Link href={locale == "en" ? "/fr" : "/en"} locale={locale == "en" ? "fr" : "en"} scroll={false}>
