    ...
    return (
        <section className="grid min-h-screen bg-hero items-center overflow-hidden">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-5xl text-white font-bold">{publicRuntimeConfig.name}</h1>
            ...
            >
                <a href={`https://github.com/${publicRuntimeConfig.githubUsername}`} target="_blank" rel="noreferrer" className="hero-link">
                    <FontAwesomeIcon icon={faGithub} />
                    &nbsp;&nbsp;{t("github")}
                </a>
                <a href={publicRuntimeConfig.linkedinUrl} target="_blank" rel="noreferrer" className="hero-link">
